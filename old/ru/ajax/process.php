  ...
  foreach ( $_POST as $key => $val ) {
    if ( preg_match( $test, $val ) ) {
      exit;
			...
			$message .= "<tr><td><strong>Oggetto:</strong> </td><td>" . strip_tags($_POST['subject']) . "</td></tr>";
			$message .= "<tr><td><strong>Messaggio:</strong> </td><td>" . htmlentities($_POST['text']) . "</td></tr>";
			$message .= "</table>";
			$message .= "</body></html>";
